...
public class shownote extends javax.swing.JDialog {
    ...
    public shownote(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public shownote(notes selectedTask) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                shownote dialog = new shownote(new javax.swing.JFrame(), true);
